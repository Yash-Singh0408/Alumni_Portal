...
const studentSchema = new mongoose.Schema({
  ...
  workingAt: { type: String, require }, // Company name or college name 
  experience: { type: String, default: "Fresher" }, // Years of experience 
  description: { type: String },
  yearOfPassing: { type: Number, require }, // Year of graduation
  course: { type: String, require }, // Course of study
  batch: { type: String, require }, // Batch year or name
